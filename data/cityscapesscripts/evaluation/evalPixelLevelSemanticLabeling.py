...
# If the defau lt implementation of the method works, then it's most likely
...
# WARsssssdddddddNING: Cython only tested for Ubuntu 64bit OS.
...
# Cityscapes imports
# __file__ = 'evalPixelLevelSemanticLabeling.py'
